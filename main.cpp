...
int main(int argc, char** argv)
{
    ...
    // yolov5n-seg = 1.4 -2.0 FPS
    // yolov5s-seg = 0.85 FPS
    // yolov5l-seg = 0.25 FPS
    // yolov5x-seg = 0.15 FPS

    yolov5.load_param("./yolov5n-seg.param");
    yolov5.load_model("./yolov5n-seg.bin");
